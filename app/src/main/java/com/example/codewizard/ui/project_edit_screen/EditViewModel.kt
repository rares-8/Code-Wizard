package com.example.codewizard.ui.project_edit_screen
...
class EditViewModel(private val projectsRepository: ProjectsRepository) : ViewModel() {
    ...
    suspend fun saveProject() {
        projectsRepository.updateProject(projectUiState.project)
    }
